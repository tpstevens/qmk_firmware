...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT_all(
		...
		KC_LCTL, KC_LGUI, KC_LALT, MO(_FN),                   KC_SPC,  KC_MUTE,                           KC_MUTE, KC_SPC,                                      KC_LALT, MO(_FN), KC_LGUI, KC_LCTL, 
                                                                       KC_ENT,                            KC_ENT
 ),

   [_FN] = LAYOUT_all( 
		KC_TILD, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                                             KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,          KC_DEL,
