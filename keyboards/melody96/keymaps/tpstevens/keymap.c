...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_all(
        ...
        MO(_F1), KC_A,    KC_S,    KC_D,       KC_F,       KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,                    KC_P4,   KC_P5,   KC_P6,   KC_PPLS,
        KC_LSFT, KC_NUBS, KC_Z,    KC_X,       KC_C,       KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,          KC_RSFT, KC_P1,   KC_P2,   KC_P3,   KC_PENT,
        KC_LCTL, KC_LGUI, KC_LALT,                                  KC_SPC,                             KC_RALT, KC_RCTL, KC_LEFT, MO(_F2), KC_RGHT, KC_P0,   KC_P0,   KC_PDOT, KC_PENT
    ),
    [_F1] = LAYOUT_all(
